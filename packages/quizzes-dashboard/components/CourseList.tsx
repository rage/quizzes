...
const CourseCard: React.FC<CourseCardProps> = ({ courseId, name, abbreviation, active}) => {
  return (
...
const CourseList = ({ data, error }: CourseListProps) => {
  ...
  const getFilteredAndSortedCourses = () => {
    ...
    if (filterWord.trim() !== "") {
      ...
      courses = courses.filter(course => course.title.toLowerCase().includes(filterWordLowerCase) || course.abbreviation.toLowerCase().includes(filterWordLowerCase))
    }
    switch (sortOrder) {
        ...
        <SortingContainer>
          <SelectContainer>
           ...
           onChange={(evt) => {setSortOrder(evt.target.value)
            ...
            >
              <MenuItem value={"alphabetic-ascending"}>Ascending alphabetical order</MenuItem>
              <MenuItem value={"alphabetic-descending"}>Descending alphabetical order</MenuItem>
              <MenuItem value={"created-at-latest-first"}>Created at, latest first </MenuItem>
              <MenuItem value={"created-at-oldest-first"}>Created at, oldest first </MenuItem>
              <MenuItem value={"updated-at-latest-first"}>Updated at, latest first </MenuItem>
              <MenuItem value={"updated-at-oldest-first"}>Updated at, oldest first </MenuItem>
            </TextField>
