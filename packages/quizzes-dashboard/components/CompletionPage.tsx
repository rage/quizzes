...
import { CompletionProperties, fetchCourseQuizzes, updateCourseCompletionProperties } from "../services/quizzes"
...
const CompletionPage = () => {
    ...
    const [completionValues, setCompletionValues] = useState<CompletionProperties | null>(null)
    ...
    const handleSubmission = async (
        ...
        const changedProperties: CompletionProperties = {
            ...(values.maxReviewSpamFlags !== completionValues?.maxReviewSpamFlags && {
            ...
            ...(values.minPeerReviewsGiven !== completionValues?.minPeerReviewsGiven && {
                minPeerReviewsGiven: values.minPeerReviewsGiven
            }),
            ...(values.minPeerReviewsReceived !== completionValues?.minPeerReviewsReceived && {
        ...
        if (!_.isEmpty(changedProperties)) {
            ...
            const newValues = await updateCourseCompletionProperties(id, changedProperties)
