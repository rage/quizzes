...
export const ValidityRegexTesterModalContent = ({
  item,
}: ModalContentProps) => {
  ...
  const checkTestAnswer = (): boolean => {
    ...
    const test = variables.validityRegexTestAnswer
    const validatorRegex = variables.regex
    ...
    <>
      ...
      <ModalContent>
        <TextField
          ...
          onChange={event =>
            dispatch(
              setValidityRegexTestAnswer(storeItem.id, event.target.value),
            )
          }
        />
      </ModalContent>
...
export default ValidityRegexTesterModalContent
