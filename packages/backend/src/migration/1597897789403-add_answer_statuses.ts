...
export class addNewStatusValues1587368274093 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      ...
      "create type quiz_answer_status_enum_new as enum ('draft', 'given-more-than-enough', 'manual-review-once-received-enough-given-more-than-enough', 'given-enough', 'manual-review-once-received-enough', 'submitted', 'manual-review-once-given-enough', 'manual-review-once-given-and-received-enough', 'manual-review', 'confirmed', 'enough-received-but-not-given', 'spam','rejected','deprecated')",
    )
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
      "create type quiz_answer_status_enum_rollback as enum ('draft', 'given-more-than-enough', 'given-enough', 'submitted',  'manual-review', 'confirmed', 'enough-received-but-not-given', 'spam','rejected','deprecated')",
    )
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
