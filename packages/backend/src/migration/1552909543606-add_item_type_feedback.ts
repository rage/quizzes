...
export class addItemTypeFeedback1552909543606 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
      "create type quiz_item_type_enum_new as enum ('open', 'scale', 'essay', 'multiple-choice', 'checkbox', 'research-agreement', 'feedback')",
    )
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
      "create type quiz_item_type_enum_rollback as enum ('open', 'scale', 'essay', 'multiple-choice', 'checkbox', 'research-agreement')",
    )
    await queryRunner.query(
      // tslint:disable-next-line:max-line-length
