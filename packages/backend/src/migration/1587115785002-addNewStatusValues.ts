...
export class addNewStatusValues1587115785002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            ...
            "create type quiz_answer_status_enum_new as enum ('draft', 'given-more-than-enough', 'given-enough', 'manual-review-once-given-and-received-enough', 'manual-review-once-given-enough', 'submitted',  'manual-review', 'confirmed', 'enough-received-but-not-given', 'spam','rejected','deprecated')",
        )
        await queryRunner.query(
            // tslint:disable-next-line:max-line-length
